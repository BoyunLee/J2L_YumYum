...
import com.ssafy.yumyum.global.security.jwt.AdminTokenAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        AdminTokenAuthenticationFilter adminTokenAuthenticationFilter =
                new AdminTokenAuthenticationFilter(tokenProvider, adminUserDetailsService);
        http
        ...
        http.addFilterBefore(tokenAuthenticationFilter, AdminTokenAuthenticationFilter.class);
